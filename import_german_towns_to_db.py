...
print(f"Reading german_towns.csv...")
try:
    # Read the CSV file
    df = pd.read_csv("german_towns.csv")
    print(f"✓ Successfully read {len(df)} rows from german_towns.csv")
    ...
    print("✗ Error: german_towns.csv not found")
    exit()
