...
# Austrian towns data - 100 most populous municipalities (2025 estimates)
austria_towns_data = [
...
try:
    ...
    for location_data in data:
        ...
        # Add time and timezone info from the location response
    ...
    print(f"✓ Saved to MySQL database OpenMeteo.{table_name}")
